...
function Footer() {
    return (
        <div className="cv-footer spacer-top">
            <div className="container">
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="cv-foot-box cv-foot-logo">
                            <img
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="cv-foot-box cv-foot-newsletter">
                            <h2>Newsletter</h2>
                            <p>Sign up for our newsletter</p>
                            <form>
                                <input type="text" placeholder="Enter your email" />
                                <button className="cv-btn">subscribe</button>
                            </form>
                            <div className="cv-foot-payment">
                                <a href="#"
                                ><img
                                        src="src/assets/images/pay1.png"
                                        alt="image"
                                        className="img-fluid"
                                    /></a>
                                <a href="#"
                                ><img
                                        src="src/assets/images/pay2.png"
                                        alt="image"
                                        className="img-fluid"
                                    /></a>
                                <a href="#"
                                ><img
                                        src="src/assets/images/pay3.png"
                                        alt="image"
                                        className="img-fluid"
                                    /></a>
                                <a href="#"
                                ><img
                                        src="src/assets/images/pay4.png"
                                        alt="image"
                                        className="img-fluid"
                                    /></a>
                            </div>

                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="cv-feature-box">
                                ...
                                <div className="cv-feature-text">
                                    <Link className="fs-4 text-dark fw-bold" to={"/disease"}>Disease Prediction(DL)</Link>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cv-feature-box">
                                ...
                                <div className="cv-feature-text">
                                    <a className="fs-4 text-dark fw-bold" href='http://127.0.0.1:5500/predict.html' target='_blank'>Disease Diagonisis</a>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cv-feature-box">
                                ...
                                <div className="cv-feature-text">
                                    <Link className="fs-4 text-dark fw-bold" to={"/shop"}>Buy Medicines</Link>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cv-feature-box">
                                ...
                                <div className="cv-feature-text">
                                    <Link className="fs-4 text-dark fw-bold" to={"/make-appointment"}>Make Appointment</Link>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <ul className="cv-service-ul">
                                ...
                                <li>
                                    <div className="cv-service-box">
                                        <div className="cv-service-icon">
                                            <svg viewBox="0 0 512.114 512.114" xmlns="http://www.w3.org/2000/svg"><g><path d="m256.057 60.118c15.242 0 30.27 1.419 45.002 4.202v-34.32h30v-30h-150.004v30h30v34.32c14.732-2.783 29.76-4.202 45.002-4.202z" /><path d="m256.057 90.118c-116.531 0-210.998 94.467-210.998 210.998s94.467 210.998 210.998 210.998 210.998-94.467 210.998-210.998-94.467-210.998-210.998-210.998zm0 346.994c-74.988 0-135.996-61.008-135.996-135.996s61.008-135.996 135.996-135.996 135.996 61.008 135.996 135.996-61.008 135.996-135.996 135.996z" /><path d="m271.057 286.116h89.93c-6.611-46.466-43.464-83.318-89.93-89.93z" /><path d="m241.057 316.116v-119.93c-51.368 7.309-90.996 51.575-90.996 104.93 0 58.446 47.55 105.996 105.996 105.996 53.355 0 97.621-39.628 104.93-90.996z" /></g></svg>
                                        </div>
                                        <div className="cv-service-text">
                                            <h3>Fast delivery</h3>
                                            <p>Quis nostrud exercitation ullamco laboris nisi ut commodo consequat.</p>
                        ...
                        <div className="col-lg-4">
                            <div className="cv-service-img">
                                <img src="src/assets/images/service-img.png" alt="image" className="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>

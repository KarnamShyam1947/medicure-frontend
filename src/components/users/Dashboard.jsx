          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="cv-feature-box">
                ...
                <div className="cv-feature-text">
                  <Link className="fs-4 text-dark fw-bold" to={"/manage-doctor"}>Doctors</Link>
                  <p>By qualified Doctors</p>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
              <div className="cv-feature-box">
                ...
                <div className="cv-feature-text">
                  <Link className="fs-4 text-dark fw-bold" to={"/manage-medicine"}>Medicines</Link>
                  <p>By qualified Doctors</p>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
              <div className="cv-feature-box">
                ...
                <div className="cv-feature-text">
                  <Link className="fs-4 text-dark fw-bold" to={"/manage-department"}>Departments</Link>
                  <p>By qualified Doctors</p>
                </div>
              </div>
            </div>
